...
if __name__ == "__main__":
    ...
    print("TIPO DE MODELO QUE QUIERE UTILIZAR (default = [3] mfcc): [1] melspectrogram | [2] spectrogram | [3] mfcc")
    modeloPorUtilizar = input()
    ...
    # Cargar el dataset
    print("DATASET POR UTILIZAR (default = [1] medleys): [1] medleys | [2] irmas")
    datasetPorUtilizar = input()
    if datasetPorUtilizar == "2":
        ...
        ANNOTATIONS_FILE = 'Medley_validacion_Metadata.csv'
        AUDIO_DIR = "validacion"
